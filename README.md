...
ezoncoin-subsidy-python:

    cd ezoncoin-subsidy-python
    python setup.py install

Running P2Pool:
-------------------------
To use P2Pool, you must be running your own local ezoncoind. For standard
...
* chaeplin, dstorm and mr.slaveg from the Ezoncoin Community
