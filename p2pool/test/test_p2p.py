    ...
    def test_sharereq(self):
        class MyNode(p2p.Node):
            def __init__(self, df):
                p2p.Node.__init__(self, lambda: None, 29333, networks.nets['ezoncoin'], {}, set([('127.0.0.1', 9333)]), 0, 0, 0, 0)
        ...
        class MyNode(p2p.Node):
            ...
            def got_conn(self, conn):
                ...
                for i in xrange(3):
                    ...
                    new_mining_txs[ezoncoin_data.hash256(ezoncoin_data.tx_type.pack(huge_tx))] = huge_tx
